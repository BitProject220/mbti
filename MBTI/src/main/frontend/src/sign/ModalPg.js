  ...
  return (
    ...
    >
      ...
      <Modal.Body>
        ...
        <br />
        <br />
        <h2 style={{textAlign:'left'}}>1. 소개</h2>
        <br />
        <p>
        ...
        <br />
        <br />
        <h2 style={{textAlign:'left'}}>2. 등록</h2>
        ...
        <br />
        <br />
        <h2 style={{textAlign:'left'}}>3. 성격검사</h2>
        <br />
        <br />
        ...
        <br />
        <br />
        <h2 style={{textAlign:'left'}}>4. 디지털 콘텐츠 및 서비스 구매</h2>
        <br />
        <br />
        ...
        <br />
        <br />
        <h2 style={{textAlign:'left'}}>팀 도구</h2>
        <br />
        <br />
        ...
        <br />
        <br />
        <h2 style={{textAlign:'left'}}>5. 환불 및 취소 정책</h2>
        <br />
        <br />
        ...
        <br />
        <br />
        <h2 style={{textAlign:'left'}}>6. 웹사이트/제품 사용 허가</h2>
        <br />
        <br />
        ...
        <br />
        <br />
        <h2 style={{textAlign:'left'}}>7. 허용되는 사용</h2>
        <br />
        <br />
        ...
        <br />
        <br />
        <h2 style={{textAlign:'left'}}>8. 사용자 생성 콘텐츠</h2>
        <br />
        <br />
        ...
        <br />
        <br />
        <h2 style={{textAlign:'left'}}>9. 공지 및 게시 중단</h2>
        <br />
        <br />
        ...
        <br />
        <br />
        <h2 style={{textAlign:'left'}}>10. 원치 않는 아이디어 제출</h2>
        <br />
        <br />
        ...
        <br />
        <br />
        <h2 style={{textAlign:'left'}}>11. 제한된 보증/보증</h2>
        <br />
        <br />
        ...
        <br />
        <br />
        <h2 style={{textAlign:'left'}}>12. 책임의 제한 및 배제</h2>
        <br />
        <br />
        ...
        <br />
        <br />
        <h2 style={{textAlign:'left'}}>13. 배상</h2>
        <br />
        <br />
        ...
        <br />
        <br />
        <h2 style={{textAlign:'left'}}>14. 약관 위반</h2>
        <br />
        <br />
        ...
        <br />
        <br />
        <h2 style={{textAlign:'left'}}>19. 완전한 합의</h2>
        <br />
        <br />
        ...
        <br />
        <br />
        <h2 style={{textAlign:'left'}}>20. 본 계약 이행의 지연</h2>
        <br />
        <br />
        ...
        <br />
        <br />
        <h2 style={{textAlign:'left'}}>21. 법률 및 소송</h2>
        <br />
        <br />
        ...
        <br />
        <br />
        <h2 style={{textAlign:'left'}}>22. 우리의 세부 사항</h2>
        <br />
        <br />
        ...
        <br />
        <br />
        <h2 style={{textAlign:'left'}}>23. 대체 분쟁 해결</h2>
        <br />
        <br />
        ...
        <br />
        <br />
        <h2 style={{textAlign:'left'}}>24. 귀하의 법적 권리 요약</h2>
        <br />
        <br />
