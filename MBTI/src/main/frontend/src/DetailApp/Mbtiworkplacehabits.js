...
const Mbtiworkplacehabits = ({ id }) => {
    ...
    return (
        <div>
            ...
            <img src={data.url} alt='직장에서 보이는 습관' style={{ width: 80+'%', height: 300,}} />
            </div>
            <div className='sticky'>           
                <div className='sidediv-left'
                        ...
                        <a href='/Mbtiworkplacehabits' className='thispage'><li >직장에서 보이는 습관</li></a>
                        <a href='/Mbticonclusion' className='atherside'><li >결론</li></a>
                        </ul>
                </div>
                <Workplacehabits id='1' /> {/*  id 값에 전달 //*/}  
            </div>
